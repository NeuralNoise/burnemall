...
// BEN ici, j'ai utiliser une arraylist sans trop savoir quelle est la meilleur collection � utiliser pour un anneau d'objets.
// j'ai cherch� sur le net pour une collection qui acceler le traitement de la recherche d'objet, mais je n'ai rien trouv�
// d'ideal.

//BEN les supress warning et le serialVersion, j'y comprend rien, j'ai fait comme eclipse m'a propos�. il y a quelque chose � savoir?
